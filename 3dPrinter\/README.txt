...
http://www.thingiverse.com/thing:3432384
Mulbot - The Mostly Printed 3D Printer by 3DPRINTINGWORLD is licensed under the Creative Commons - Attribution - Non-Commercial license.
http://creativecommons.org/licenses/by-nc/3.0/

# Summary

###The Mulbot is a open source mostly printed printer that I designed to show the people at the Midwest Rep Rap Festival (MRRF) 2019! 
...
## 3D printed Kinematics

I figured since the bearings where 3D printed I would print some other parts as well. For example the X-axis uses a 3D printed double wide TPU timing belt and printed drive and Idle pulleys. The Y-axis uses a printed rack and pinion to traverse the bed. The Z-axis is driven by two over sized printed trapezoidal nuts and screws.
https://youtu.be/Ob4yieqQDis

<iframe src="//www.youtube.com/embed/Ob4yieqQDis" frameborder="0" allowfullscreen></iframe>
Intro Video

![Alt text](https://cdn.thingiverse.com/assets/de/07/79/77/7c/MULBOT-DL1.png)
Version DL1
...
Printed on my Original Prusa MK3. 


## Print Surface

I printed all the parts on the Prusa MK3 stock cast aluminum bed with PEI flex plate.  If I had the choice I would have preferred to print on a glass as it would be much flatter. Having said that, because of the way the frame is design I don’t think bed flatness is a big deal. 
...
Note: I did have some softening of the gear pinion and the drive pulley as a result of the heat from the stepper motors so I did end up printing those twp parts out of ABS, but PETG would probably work as well. 
...
I used Solutech for all the PLA printed parts. 

*   1 x [Spool Real Red][RED]
*   2 x [Spool Real White][WHITE]
*   1 x [Spool Real Blue][BLUE]

It takes less then 2kg of filament in total to make the entire printer.
...
Both PLA and TPU will also print great on the non-heated glass bed with a little glue stick.
...
I have highlighted some of the components below as well as I'll publish a PDF of the full BOM in the file section. 

When selecting the purchased components please consider supporting our sponsors. When I showed them the design and told them my plan to bring the printer to MRRF they all were happy to help out. 
...
*   Filastruder: [Genuine E3D Lite6 Hot End][hot] 

I thought the Lite6 was a perfect fit for this printer because of its reliability’s and low price tag, around $30. Sure you can order a clone; wait five weeks, maybe save a few bucks, but the loss of quality is just not worth it in my option. Plus I like to support opensource company’s like E3D because the clones wouldn’t existed without them. You will want the 1.75mm Bowden type and the 12v version if your running ramps. 

I received mine from Filastruder which is an official e3d distributor. Depending on where you live you might even get it faster from them then Amazon. 
...
*   Matterhackers: [SeeMeCNC EZR][ezr]

Since the printer doesn’t have a heated bed I thought it would be good to have an extruder that can print both PLA and TPU.  Both materials will print perfectly well with a non-heated glass bed with a little glue stick. The extruder is great at PLA but also at TPU as the filament is better guided through the extruder. What I think makes this extruder most unique is that the pressure roller moves linearly instead of radially on an arm so the pressure stays perpendicular to the path of the filament. You would think that this  would help with flex but at the very least it’s a cool design. 

The other thing that is cool is since SeeMeCNC is an open source company I was able to down load the actual 3D models of the extruder from their GitHub page! This made life so easy when it came to the design for the extruder. The other thing is its only $35 which is almost half the cost of other extruders on the market which makes it perfect for this printer. You don’t even have to worry about it causing you inconsistent extrusion. :) Additionally SeeMeCNC is  a major sponsor at MRRF, which is a plus.
...
*   Amazon: [M3 Tread Inserts][m3] or Mcmaster: [94180A331][mc]
*   Amazon: [M4 Tread Inserts][m4] or Mcmaster: [94180A351][mc1]
*   Amazon: [Heat-Set Install Tip][tip]

[m3]: https://amzn.to/2Yttlq2
[m4]: https://amzn.to/2Xj3ikD
[tip]: https://amzn.to/2FlXl01
[mc]: https://www.mcmaster.com/94180a331
[mc1]: https://www.mcmaster.com/94180a351


## Misc Hardware

Bed Springs
4  X 7.5MM OD X 20M LG X 1.2MM Wire Compression Spring
*    [Aliexpress][spring]
*    [Amazon][amz]

[amz]:https://amzn.to/2OmXe6K
...
*   Amazon: [12v. Blower fan][fan]


[fan]: https://amzn.to/2TuMqnU
...
I did have to rotate some of the longer frame members 40 degrees or so to get them to fit on the bed of my Prusa MK3.
...
Hopefully everyone’s bearings will have just the right amount of preload, but not everyone’s printer will be the same so this probably is not going to happen... I would say the relationship between the rails and the bearing need to be within +/- .005” to function properly. You can modify the ".stp" file if your preload is not right you can try scaling the Y axis(as the model comes in your slicer) slightly to compensate. I would try scaling it up or down roughly .7% which would equate to .005”.  
...
<iframe src="//www.youtube.com/embed/cF8fXATjccQ" frameborder="0" allowfullscreen></iframe>
He is a quick video showing the assembly of the original bearings.

## Cleanup and Deburr

Burrs and unsmooth print surfaces will affect your bearings performance.  I have noticed that the bearings run a little rough at first but get smother as they break in.  I believe this is a result of the endcaps not being smoothed and/or having burrs.  Make sure the balls can freely flow thru each return track and end cap by manually dropping a single bearing ball in each hole. After the bearings have been broken in I have not noticed any issues with wearing. 
...
I did not design a custom spool holder for this project but instead I utilized Filamentry's [Tush][tush] spool holder.  Its a really easy print and works great! 

[tush]:https://www.thingiverse.com/thing:2047554

# Assembly

## You can also find PDF of all the drawings in the files section.

To see a larger image, right click and open the drawing in a new window. 

![Alt text](https://cdn.thingiverse.com/assets/b9/bc/93/68/0c/DL1-MULBOT_ASSY-PG1.png)
General Assembly

![Alt text](https://cdn.thingiverse.com/assets/f0/93/61/a5/77/DL1-MULBOT_ASSY-PG2.png)
Overall Footprint
...
[komb]: https://www.thingiverse.com/thing:173516


![Alt text](https://cdn.thingiverse.com/assets/19/24/94/54/10/DL1-01_Y-AXIS_FRAME.png)
Y-axis Frame Assembly

![Alt text](https://cdn.thingiverse.com/assets/97/a2/66/7d/d9/DL1-03_BED_ASSEMBLY.png)
Bed Assembly
...
![Alt text](https://cdn.thingiverse.com/assets/44/c6/1d/b7/5f/DL1-02_Z-AXIS_FRAME.png)
Z-axis Assembly

![Alt text](https://cdn.thingiverse.com/assets/21/ea/96/ca/25/DL1-04_X-AXIS_ASSEMBLY.png)
X-Axis Assembly
...
![Alt text](https://cdn.thingiverse.com/assets/00/59/51/a0/0d/DL1-05_DISPLAY_ASSEMBLY.png)
Display Assembly

The X-axis idle pulley uses the same 4.5mm bearing balls that the linear bearings use.

![Alt text](https://cdn.thingiverse.com/assets/a9/79/60/51/b0/DL1-06_IDLER_ASSEMBLY.png)
Idle Roller Assembly

# Controller & Firmware

## Marlin and Ramps 1.4

I am running [Marlin][mar] on the ramps board which I really like and was a lot of fun to configure! I have not posted my configuration files but if it will help some people out I would be happy to do so, just let me know. 
...
I have not tried any lubrication on the recirculating bearings yet.  I did try some PTFE spray on the single row version and it caused the ball to not recirculate properly so I have not experimented with it since. 
...
The printed belt uses a standard GT2 pitch so there is no reason why you could not switch out the TPU belt for a purchased timing belt.
...
## 3D Printing World and the Mulbot will be at MRRF 2019!  

Thanks to our sponsors for providing the components necessary to bring a finished Mulbot to show everyone at MRRF this year! Hope to see you there!
...
![Alt text](https://cdn.thingiverse.com/assets/fd/eb/40/a4/32/MULBOT-BANNER.png)
MRRF 2019 Sponsers
...
I just realized that I never uploaded the file for the TPU belt.  You can find it in the file section now. "DL1-04-15_X-AXIS BELT.stl"

## 3/26/19

I noticed that the idle pulley would tilt from the tension of the belt as a result of the clearance in the take up block. Plus, the idle pulley assembly is hard to keep tight.  As a result I made the take up block two piece so once in position the block can be clamped in place. I also integrated the pulley shaft into the block. I will updated the 2D drawing when I get a chance. 
